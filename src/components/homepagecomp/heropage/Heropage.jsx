  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-center text-nowrap my-3">
        <p className="text-5xl md:text-6xl lg:text-[120px] py-3">
          INDIAN SOCIETY
        </p>
        <p className="text-4xl md:text-5xl lg:text-7xl py-2 md:py-3 hover:text-[#27A5EF] transition-all duration-150 ease-in-out">
          FOR
        </p>
        <p className="text-5xl md:text-6xl lg:text-[120px] py-3">
          TECHNICAL EDUCATION
